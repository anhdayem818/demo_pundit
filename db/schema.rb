...
ActiveRecord::Schema.define(version: 20151103025106) do
  ...
  create_table "spree_albums", force: :cascade do |t|
    t.string   "name",           limit: 255
    t.string   "tag",            limit: 255
    t.integer  "cover_photo_id", limit: 4
  ...
  create_table "spree_black_lists", force: :cascade do |t|
    t.string   "ip",         limit: 255
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_blog_entry_taxons", force: :cascade do |t|
  ...
  create_table "spree_comments", force: :cascade do |t|
    ...
    t.string   "commentID",    limit: 255
    t.text     "message",      limit: 65535
    t.boolean  "read",                       default: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "fb_post_id",   limit: 255
    t.string   "fb_parent_id", limit: 255
  ...
  create_table "spree_fb_posts", force: :cascade do |t|
  ...
  create_table "spree_leads", force: :cascade do |t|
    t.integer  "user_id",      limit: 4
    t.integer  "product_id",   limit: 4
    t.string   "fb_post_id",   limit: 255
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.integer  "pre_tax_amount",       limit: 4
  end
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.integer  "authorized_approver_id", limit: 4
  ...
  create_table "spree_payment_members", force: :cascade do |t|
    t.text     "content",    limit: 65535
    t.string   "trx_id",     limit: 255
    t.string   "state",      limit: 255
  ...
  add_index "spree_payment_members", ["user_id"], name: "index_spree_payment_members_on_user_id", using: :btree
  ...
  create_table "spree_photos", force: :cascade do |t|
  ...
  create_table "spree_post_offices", force: :cascade do |t|
  ...
  create_table "spree_slider_images", force: :cascade do |t|
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.integer  "product_id",      limit: 4
    t.decimal  "cost_price",                  precision: 12
